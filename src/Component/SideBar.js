      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <List>
            ...
            <Link to="/exam-fees"style={{ textDecoration: 'none', color: 'inherit' }}><AssessmentIcon />EXAM FEES </Link><br></br>

             {/* {["COURSE FEE DETAILS", "REGISTRATION FEES", "EXAM FEES"].map((text, index) => (
